...
| Conditional data building helper | 2026-01-29 | Created `_build_data_dict()` helper method in api.py to replace duplicate data dict building patterns (refactored 9 functions: update_checklist, update_checklist_item, add_dependency, delete_dependency, add_task_link, delete_task_link, create_list, update_task, update_time_entry) |
