...
```json
{
  ...
  "paths": {
    "/api/v3/workspaces/{workspace_id}/chat/channels/{channel_id}/followers": {
      "get": {
        "operationId": "getChatChannelFollowers",
        "summary": "Retrieve Channel followers",
        ...
        "parameters": [
          {
            ...
            "schema": {
              "type": "integer",
              "x-readme-ref-name": "ChatPublicApiChatChannelsControllerGetChatChannelFollowersWorkspaceIdPath"
            }
          },
          {
            "name": "channel_id",
          ...
          },
          {
            ...
            "schema": {
              ...
              "maximum": 100,
              "minimum": 1,
              "x-readme-ref-name": "ChatPublicApiChatChannelsControllerGetChatChannelFollowersLimitQuery"
            }
          }
        ],
        "responses": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "x-readme-ref-name": "ChatPublicApiChatChannelsControllerGetChatChannelFollowers200Response"
                }
              }
            }
          },
