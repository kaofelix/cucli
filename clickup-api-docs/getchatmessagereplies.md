  ...
  "paths": {
    "/api/v3/workspaces/{workspace_id}/chat/messages/{message_id}/replies": {
      "get": {
        ...
        "summary": "Retrieve message replies",
        "description": "This endpoint retrieves the replies to a message.",
        "parameters": [
          {
            "name": "workspace_id",
            "in": "path",
            ...
            "schema": {
              "type": "integer",
              "x-readme-ref-name": "CommentPublicApiChatMessagesControllerGetChatMessageRepliesWorkspaceIdPath"
            }
          },
          {
            "name": "message_id",
          ...
          },
          {
            ...
            "schema": {
              ...
              "maximum": 100,
              "minimum": 1,
              "x-readme-ref-name": "CommentPublicApiChatMessagesControllerGetChatMessageRepliesLimitQuery"
            }
          },
          {
            "name": "content_format",
            ...
            "schema": {
              ...
              "x-readme-ref-name": "CommentPublicApiChatMessagesControllerGetChatMessageRepliesContentFormatQuery"
            }
          }
        ],
        "responses": {
                      ...
                      "properties": {
                        "data": {
                          ...
                          "items": {
                                ...
                                "allOf": [
                                  {
                                    ...
                                    "x-readme-ref-name": "CommentReplyMessageLinks2"
                                  }
                                ]
                              }
                            },
                            ...
                            "x-readme-ref-name": "ReplyMessage"
                          }
                        }
                      }
                    }
                  ],
                  "x-readme-ref-name": "CommentPublicApiChatMessagesControllerGetChatMessageReplies200Response"
                }
              }
            }
          },
