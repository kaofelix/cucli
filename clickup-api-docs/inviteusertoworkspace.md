  ...
  "paths": {
    "/v2/team/{team_id}/user": {
      "post": {
        ...
        "description": "Invite someone to join your Workspace as a member. To invite someone as a guest, use the [Invite Guest](https://developer.clickup.com/reference/inviteguesttoworkspace) endpoint.\\\n \\\n***Note:** This endpoint is only available to Workspaces on our [Enterprise Plan](https://clickup.com/pricing).*",
